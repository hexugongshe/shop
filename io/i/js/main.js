...
var setAmount = {
    ...
    reduce:function(obj) {
        ...
        if (x >= this.min) {
            $(obj).val(x);
            $(".product_num").html(x);
     	    var summary_cost = x * parseInt( $(".unit_price").html());
    		$(".summary_cost").html(summary_cost+".00");
            recalc();
        } else {
...
var pullSpeed = 500;
var purcharseHeight = parseInt($("#purcharse").height())+parseInt($("#confirm").height()+300);
$("#purcharse").css('top',purcharseHeight);

var purchasehide = function(height,speed){
		return $("#purcharse").animate({
			top: purcharseHeight,
		},pullSpeed,"linear").promise();
}
...
$("#buyBtn").click(function(){
	$("#purcharse").removeClass('disnone');
	$("#buyBtn").addClass('disnone');
	$("#contact2").addClass('disnone');
	$("#shadow").removeClass('disnone');
	$("#purcharse").animate({
			top: 0,
		},pullSpeed,"linear");
...
$("#cicon").click(function(){
	$("#buyBtn").removeClass('disnone');
	$("#contact2").removeClass('disnone');
	$("#shadow").addClass('disnone');
	
	$.when(purchasehide(purcharseHeight,pullSpeed)).then(function(){
		$("body").css('overflow','auto');
		$("#purcharse").addClass('disnone');
	});
...
//		$(".choose").css("backgroundColor","#ddd");
//	})
//
//
//	//返回键
